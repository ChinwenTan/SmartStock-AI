...
export default function AuthLogin({ onBack, onSwitchSignUp, onSuccess }) {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-[36px] bg-white p-6 shadow-bento ring-1 ring-black/5">
        <p className="font-display text-2xl text-zinc-900">Welcome back</p>
        <p className="mt-2 text-sm text-zinc-500">Sign in to manage stock and generate promos.</p>
        ...
        <div className="mt-5 flex items-center justify-between">
          <p className="text-xs text-zinc-500">No account?</p>
          <button
            type="button"
